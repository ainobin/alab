...
% 1. Time Shifting (Delay by 2)
n_shift = n + 2;

% 2. Time Scaling (Amplitude Scaling by 2)
x_scale = 2 * x;
...
hold on;
plot(n_shift,x, 'blue', 'LineWidth',1);
grid on;
...
hold on;
plot(n, x_scale, 'blue', 'LineWidth',1);
grid on;
...
subplot(2,2,4);
stem(n_reverse, x_reverse, 'filled');
hold on;
plot(n_reverse, x_reverse, 'blue', 'LineWidth',1);
grid on;
